...
# test_batchsize = 10
# test_x = torch.normal(0,1,(test_batchsize,num_inputs))
# test_output = torch.mm(test_x,W)+b#mm or matmul
...
test_x = torch.normal(0,1,(12,num_inputs))
# test_y = softmax(test_x)
# print(torch.sum(test_y,dim=1))
...
# print(y_hat[:, y]) #tensor([[0.1000, 0.6000], [0.3000, 0.5000]])
def cross_entropy(y_hat,y):
    return - torch.log(y_hat[range(len(y_hat)),y])
# b = cross_entropy(y,y_hat)
# print(b)
# def cross_entropy(y_hat, y):
#     return - torch.log(y_hat[range(len(y_hat)), y])
#
...
def updater(batch_size):
    return somework.sgd([W, b], lr, batch_size)
num_epochs = 10
